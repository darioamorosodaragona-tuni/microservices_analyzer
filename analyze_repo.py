        ...
        try:
            ...
            for g in dep_graphs:
                analysis['dep_graph_' + g] = {'nodes': dep_graphs[g].number_of_nodes(),
                                              ...
                                              'avg_deps_per_service':  sum([out_deg for name, out_deg in dep_graphs[g].out_degree]) / dep_graphs[g].number_of_nodes() if dep_graphs[g].number_of_nodes() != 0 else 0,
